...
def create_items():
    ...
    items = {
        # Ressources de base
        "wood": Item("Bois", "resource", "Matériau de base pour la construction", 99, COLORS["BROWN"]),
        "stone": Item("Pierre", "resource", "Matériau solide pour les constructions", 99, COLORS["GRAY"]),
        "iron_ore": Item("Minerai de fer", "resource", "Utilisé pour créer des outils", 99, COLORS["DARK_GRAY"]),
        ...
        # Nourriture
        "apple": Item("Pomme", "food", "Restaure 10 points de vie", 10, COLORS["RED"]),
        "berry": Item("Baie", "food", "Restaure 5 points de vie", 20, (128, 0, 128)),
        ...
        # Outils
        "wooden_sword": Item("Épée en bois", "weapon", "Arme basique", 1, COLORS["BROWN"]),
        "iron_sword": Item("Épée en fer", "weapon", "Arme solide", 1, COLORS["DARK_GRAY"]),
        ...
        "wooden_pickaxe": Item("Pioche en bois", "tool", "Outil de minage basique", 1, COLORS["BROWN"]),
        "iron_pickaxe": Item("Pioche en fer", "tool", "Outil de minage avancé", 1, COLORS["DARK_GRAY"]),
        
        # Armures
        "leather_armor": Item("Armure en cuir", "armor", "Protection basique", 1, (139, 69, 19)),
        "iron_armor": Item("Armure en fer", "armor", "Protection solide", 1, COLORS["DARK_GRAY"]),
    }
    return items
