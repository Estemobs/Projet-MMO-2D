...
def _get_assets_base_dir():
    """Retourne le chemin de base des assets, compatible PyInstaller/Flatpak/normal."""
    if getattr(sys, 'frozen', False):
        # PyInstaller : les assets sont extraits dans _MEIPASS
        return sys._MEIPASS
    else:
        # Exécution normale : remonter au dossier racine du projet
...
class SpriteManager:
    ...
    def load_all_sprites(self):
        ...
        sprites_dir = os.path.join(_get_assets_base_dir(), "assets", "sprites")
